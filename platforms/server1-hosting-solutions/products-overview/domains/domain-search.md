...
### Transfers (bring your domain to SERVER1)

* Unlock the domain at your current registrar.
* Obtain the **EPP/Auth code**.
* Start the transfer from your SERVER1 client area.
* Approve the confirmation email to complete.
* Manage DNS and renewals from one dashboard.

> Most gTLD transfers add one year to your term (registry rules apply). Any transfer fees and exact timing are shown in real time during checkout.

***

### DNS & management tools

* Nameserver management and DNS record editor
* Domain lock and EPP code retrieval
* Contact/WHOIS details management
* Optional WHOIS privacy (when supported)
* Bulk search, bulk register, bulk transfer
...
* Prefer common extensions for broad appeal
* Register variants and common misspellings
* Consider brand + keyword pairs for SEO
* Activate SSL and email as soon as you go live

***

### Ready to search?

Use the live checker to see **current availability and pricing** in real time:

{% embed url="https://console.server1.ge/cart.php?a=add&domain=register&language=english" %}

If you need help choosing a name or evaluating alternatives, tell us your brand, industry, and audience—we’ll suggest strong, available options.
...
| .bar           | Generic/Industry                | General availability (GA).                                                        |
...
| .cars          | Premium/High-Value              | Higher registry pricing; premium names and restrictions may apply.                |
...
| .com.co        | Generic/Industry                | General availability (GA).                                                        |
...
| .dev           | Tech/Startup                    | Popular with startups and developers. HTTPS required by default (HSTS preloaded). |
...
| .fans          | Generic/Industry                | General availability (GA).                                                        |
...
| .gmbh          | Generic/Industry                | General availability (GA).                                                        |
...
| .info          | Generic/Industry                | General availability (GA).                                                        |
...
| .lol           | Generic/Industry                | General availability (GA).                                                        |
...
| .net.co        | Generic/Industry                | General availability (GA).                                                        |
...
| .pics          | Generic/Industry                | General availability (GA).                                                        |
...
| .rip           | Generic/Industry                | General availability (GA).                                                        |
...
| .store         | Generic/Industry                | General availability (GA).                                                        |
...
| .tv            | Country-code (marketed generic) | Operates like a generic TLD in practice.                                          |
...
| .wtf           | Generic/Industry                | General availability (GA).                                                        |
